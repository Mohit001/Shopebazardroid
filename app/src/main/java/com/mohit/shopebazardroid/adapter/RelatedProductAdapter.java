...
public class RelatedProductAdapter extends BaseAdapter {
    ...
    public static String TAG = RelatedProductAdapter.class.getSimpleName();
    Context mContext;
    ...
    public RelatedProductAdapter(Context mContext, ArrayList<RelatedProductList> arrayList) {
    ...
    @Override
    public RelatedProductList getItem(int i) {
    ...
    public View getView(int position, View convertview, ViewGroup viewGroup) {
        ...
        RelatedProductList entity = getItem(position);
        ViewHolder holder;
...
//        TextView adp_oftd_lable, adp_latest_price, adp_old_price;
