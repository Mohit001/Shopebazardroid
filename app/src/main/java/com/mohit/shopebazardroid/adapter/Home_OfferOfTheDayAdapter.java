...
public class Home_OfferOfTheDayAdapter extends RecyclerView.Adapter<Home_OfferOfTheDayAdapter.MyViewHolder> {

    public static String TAG = HomeOfferOFTheDayAdapter.class.getSimpleName();
    Context mContext;
    ...
    public Home_OfferOfTheDayAdapter(Context mContext, ArrayList<ProductEntity> arrayList) {
...
//                .STRIKE_THRU_TEXT_FLAG);
        ...
        if (TextUtils.isEmpty(entity.getSpecial_price())) {
            ...
            holder.pd_latest_price_lbl.setText(baseCurrencyCode + " " + (String.format("%.2f",tempLatestPrice)));
