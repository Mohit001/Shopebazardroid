...
public class Home_TrendingNowAdapter extends RecyclerView.Adapter<Home_TrendingNowAdapter.MyViewHolder> {

    public static String TAG = Home_TrendingNowAdapter.class.getSimpleName();
    Context mContext;
    ...
    public Home_TrendingNowAdapter(Context mContext, ArrayList<ProductEntity> arrayList) {
