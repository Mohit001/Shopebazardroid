...
public class Home_FeatureProductsAdapter extends RecyclerView.Adapter<Home_FeatureProductsAdapter.MyViewHolder> {

    public static String TAG = Home_FeatureProductsAdapter.class.getSimpleName();
    Context mContext;
    ...
    public Home_FeatureProductsAdapter(Context mContext, ArrayList<ProductEntity> arrayList) {
