...
import com.mohit.shopebazardroid.model.response.AddressAreaResponse;
...
public class SpinnerStreetAdapter extends ArrayAdapter<AddressAreaResponse.Area> {

    private ArrayList<AddressAreaResponse.Area> list;
    private Context context;
    private LayoutInflater lInflater;

    public SpinnerStreetAdapter(Context context, ArrayList<AddressAreaResponse.Area> list) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        txt.setText(list.get(position).getArea_name());
