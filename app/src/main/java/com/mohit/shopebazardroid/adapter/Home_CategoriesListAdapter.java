...
public class Home_CategoriesListAdapter extends RecyclerView.Adapter<Home_CategoriesListAdapter.MyViewHolder> {
    ...
    public Home_CategoriesListAdapter(Context mContext, List<Category> arrayList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_home_category_list, parent, false);
