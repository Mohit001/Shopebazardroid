...
import com.mohit.shopebazardroid.model.response.CityListResponse;
...
public class SpinnerCityAdapter extends ArrayAdapter<CityListResponse.Cities> {

    private ArrayList<CityListResponse.Cities> list;
    private Context context;
    private LayoutInflater lInflater;

    public SpinnerCityAdapter(Context context, ArrayList<CityListResponse.Cities> list) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        txt.setText(list.get(position).getCityname());
