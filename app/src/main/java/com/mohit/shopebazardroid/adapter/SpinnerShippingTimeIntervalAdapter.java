...
import com.mohit.shopebazardroid.model.response.TimeIntervalResponse;
...
public class SpinnerShippingTimeIntervalAdapter extends ArrayAdapter<TimeIntervalResponse.Timeinterval> {

    private ArrayList<TimeIntervalResponse.Timeinterval> list;
    private Context context;
    private LayoutInflater lInflater;

    public SpinnerShippingTimeIntervalAdapter(Context context, ArrayList<TimeIntervalResponse.Timeinterval> list) {
