...
public class HistoryEntity {
    ...
    private String base_shipping_hidden_tax_amnt;
    ...
    private ArrayList<HistoryCartItem> items;
    private HistoryPayment payment;
    private ArrayList<HistoryStatus> status_history;

    private String return_days;
    private String web_tracking_status;
    private String disabled;
    private String delivery_date;
    private String custom_shipment_id;
    ...
    public String toString() {
        return "HistoryEntity{" +
                ...
                ", web_tracking_status='" + web_tracking_status + '\'' +
                ", disabled='" + disabled + '\'' +
    ...
    public ArrayList<HistoryStatus> getStatus_history() {
        return status_history;
    }

    public void setStatus_history(ArrayList<HistoryStatus> status_history) {
    ...
    public ArrayList<HistoryCartItem> getItems() {
        return items;
    }

    public void setItems(ArrayList<HistoryCartItem> items) {
        this.items = items;
    }

    public HistoryPayment getPayment() {
        return payment;
    }

    public void setPayment(HistoryPayment payment) {
    ...
    public void setBase_shipping_hidden_tax_amnt(String base_shipping_hidden_tax_amnt) {
    ...
    public String getWeb_tracking_status() {
        return web_tracking_status;
    }

    public void setWeb_tracking_status(String web_tracking_status) {
        this.web_tracking_status = web_tracking_status;
    }
